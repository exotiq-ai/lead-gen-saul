...
export function LoginForm() {
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      {status === 'sent' && <p className="text-sm text-emerald-300">Check your inbox. This secure link works in any browser and expires after 15 minutes.</p>}
      {status === 'error' && <p className="text-sm text-rose-300">Login email could not be sent. Wait 60 seconds and try again.</p>}
    </form>
  )
}
